...
```
   ...
   SOLANA_RPC_URL=
   BAGS_TOKEN_MINT=
   BAGS_TOKEN_DECIMALS=9
   PLATFORM_TREASURY_WALLET=
   PLATFORM_SIGNER_SECRET_KEY=
   BAGS_TOKEN_URL=
   REWARD_THRESHOLD_PERCENT=80 (can leave empty)
   REWARD_AMOUNT_TOKENS=0
   BAGS_API_KEY=
   NEXT_PUBLIC_SOLANA_RPC_URL=
   NEXT_PUBLIC_BAGS_TOKEN_MINT=
   NEXT_PUBLIC_BAGS_TOKEN_DECIMALS=9
   NEXT_PUBLIC_PLATFORM_TREASURY_WALLET=
   OPENAI_API_KEY=
   EXAM_CREATION_FEE_TOKENS=5
   NEXT_PUBLIC_EXAM_CREATION_FEE_TOKENS=5
```
